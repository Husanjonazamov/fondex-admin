...
@section('scripts')
    ...
    <script type="text/javascript">
        ...
        $(document).on("click", "input[name='isActive']", function (e) {
            ...
            if (ischeck) {
                ...
                database.collection('vendor_products').doc(id).update({
                    ...
                    await syncToDjango('vendors/products/' + id + '/', 'PATCH', {'is_publish': true});
                });
                ...
                database.collection('vendor_products').doc(id).update({
                    ...
                    await syncToDjango('vendors/products/' + id + '/', 'PATCH', {'is_publish': false});
                });
            ...
            if ($('#itemTable .is_open:checked').length) {
                ...
                if (confirm("{{trans('lang.selected_delete_alert')}}")) {
                    ...
                    $('#itemTable .is_open:checked').each(function () {
                        ...
                        await syncToDjango('vendors/products/' + dataId + '/', 'DELETE');
        ...
        $(document).on("click", "a[name='item-delete']", function (e) {
            ...
            var id = this.id;
            jQuery("#data-table_processing").show();
            await syncToDjango('vendors/products/' + id + '/', 'DELETE');
