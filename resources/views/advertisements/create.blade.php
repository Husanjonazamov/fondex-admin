...
@section('scripts')
    <script>
        ...
        //                 .reviewsSum != null && vendorData.reviewsSum != '' &&
        //                 vendorData.hasOwnProperty('reviewsCount') && vendorData.reviewsCount != 0 &&
        //                 vendorData.reviewsCount != null && vendorData.reviewsCount != '') {
        ...
        //             $('#preview-review').html((reviewsCount == 0) ? '(' + reviewsCount + ')' : '(+' +
        //                 reviewsCount + ')');
        //         }
        //     })
        // }
        ...
        async function handleVideoSelect(evt) {
            ...
            video.onloadedmetadata = function() {
                ...
                if (width > (height * 1.7)) {
                    ...
                    $(".error_top").show().html(
                        "<p>Error: Only landscape videos are allowed (width must be greater than height).</p>");
                    window.scrollTo(0, 0);
                    isVideo.value = '';
                    return false;
                }
