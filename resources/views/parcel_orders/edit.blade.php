                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group row width-50">
                                            ...
                                            <div class="placeholder_img_thumb user_image">
                                                <img class="rounded" style="width:50px" src="" alt="Parcel_image"
                                                    id="parcel_image">
                                                <span id="no-image-text" style="display:none; color:gray;">Parcel Images Not
                                                    Found</span>
                                            </div>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="address order_detail-top-box">
                                        ...
                                        <div class="form-group row widt-100 gendetail-col ">
                                            <label
                                                class="col-12 control-label"><strong>{{trans('lang.sender_name')}}:</strong>
