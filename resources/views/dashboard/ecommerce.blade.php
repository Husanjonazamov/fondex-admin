...
@section('scripts')
    ...
    <script>
        ...
        function buildHTMLSections(sectionsSnapshot) {
            ...
            html = html + '<div class="cat-item px-2 py-1 select_section ' + active_section + '"><a href="' + all_route + '" class="bg-white d-block p-2 text-center shadow-sm cat-link"><img alt="#" src="' + img_url + '"  onerror="this.onerror=null;this.src=\'' + placeholderImage + '\'" class="img-fluid mb-2"><p class="m-0 small">{{trans("lang.all")}}</p></a></div>';
